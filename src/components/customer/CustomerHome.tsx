...
export const CustomerHome: React.FC<CustomerHomeProps> = ({
  ...
  return (
    <div className="min-h-screen bg-[#fcfcfc] text-[#14213D] pb-24 md:pb-16">
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-b from-[#FFF0F5]/80 via-white to-[#fcfcfc] pt-8 pb-12 sm:pt-12 sm:pb-14 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="max-w-3xl mx-auto text-center space-y-4">
            {/* Tagline Badge */}
            <div className="inline-flex items-center gap-2 bg-white px-4 py-1.5 rounded-full shadow-sm border border-[#F42F73]/20">
              <span className="w-2 h-2 rounded-full bg-[#F42F73] animate-pulse" />
              <span className="text-xs font-bold text-[#F42F73] tracking-wide">
                "Jahan Zarurat, Wahan Diblo."
              </span>
            </div>

            {/* Main Headline */}
            <h1 className="text-3xl sm:text-5xl font-extrabold text-[#14213D] tracking-tight leading-tight">
            ...
            <div className="pt-2 flex flex-col sm:flex-row items-center justify-center gap-3">
              <button
                ...
                className="w-full sm:w-auto px-8 py-3.5 rounded-2xl bg-[#F42F73] hover:bg-[#D81B60] text-white font-extrabold text-sm sm:text-base shadow-xl shadow-[#F42F73]/25 transition-all active:scale-[0.98] flex items-center justify-center gap-2 group"
              >
                <span>Book an Assistant Now</span>
                <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
              </button>

              <div className="flex items-center gap-2 bg-white px-4 py-3 rounded-2xl border border-gray-200/80 text-xs font-bold text-[#14213D] shadow-sm">
                <span className="w-2 h-2 rounded-full bg-emerald-500" />
                <span>All Services at Flat <strong className="text-[#F42F73] font-black text-sm">₹149/hr</strong></span>
              </div>
            </div>

            {/* Trust Highlights */}
            <div className="pt-4 flex flex-wrap items-center justify-center gap-4 text-xs font-semibold text-gray-500">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 pt-8">
        <div className="flex items-center justify-between mb-4">
          <div>
            <h2 className="text-xl sm:text-2xl font-bold text-[#14213D]">Available Assistance Services</h2>
            <p className="text-xs text-gray-500 mt-0.5">Tap any service to instantly customize and book your assistant</p>
          </div>
          <div className="hidden sm:block text-xs font-bold text-[#F42F73] bg-[#FFF0F5] px-3.5 py-1.5 rounded-full border border-[#F42F73]/20">
            Fixed Flat ₹149 / Hour
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 pt-4">
          {filteredServices.map((service) => (
            <div
              ...
              className="bg-white rounded-3xl p-5 border border-gray-100 hover:border-[#F42F73] shadow-sm hover:shadow-lg transition-all duration-200 cursor-pointer flex flex-col justify-between group relative overflow-hidden"
            >
              <div>
                <div className="flex items-start justify-between gap-3">
                  <div className="w-12 h-12 rounded-2xl bg-pink-100/70 text-[#F42F73] flex items-center justify-center text-xl mb-1 group-hover:bg-[#F42F73] group-hover:text-white transition-colors shadow-sm">
                    <IconHelper name={service.icon} className="w-6 h-6" />
                  </div>
                  <div className="text-right">
                    <div className="text-[11px] font-bold text-gray-400">Fixed Rate</div>
                ...
                <div className="mt-3 flex flex-wrap gap-1.5">
                  {service.features.slice(0, 2).map((feat, idx) => (
                    <span
                      key={idx}
                      className="text-[11px] bg-gray-50 text-gray-600 px-2.5 py-0.5 rounded-lg border border-gray-100 font-medium"
                    >
                      ✓ {feat}
                    </span>
                  ))}
      ...
      {/* Geometric Callout Banner */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 pt-12">
        <div className="bg-[#F42F73] rounded-[2.5rem] p-8 sm:p-10 text-white flex flex-col md:flex-row items-center justify-between gap-8 shadow-xl shadow-pink-200/50 relative overflow-hidden">
          <div className="max-w-xl space-y-3 text-center md:text-left">
            ...
            <p className="opacity-95 text-xs sm:text-sm leading-relaxed max-w-md">
              Quickest matching across Bandra, Powai, Juhu, and South Mumbai. Verified assistants are typically 8 mins away.
            </p>
            <div className="pt-2">
              <button
                onClick={onOpenBooking}
                className="bg-white text-[#F42F73] hover:bg-gray-50 px-8 py-3.5 rounded-2xl font-black text-sm sm:text-base uppercase tracking-tight shadow-lg transition-all active:scale-95"
              >
                Book an Assistant
              </button>
            </div>
          ...
          <div className="flex gap-4 sm:gap-6 shrink-0">
            <div className="w-28 h-28 sm:w-32 sm:h-32 bg-white/20 rounded-full backdrop-blur-md flex flex-col items-center justify-center border border-white/30 text-center shadow-inner">
              <p className="text-2xl sm:text-3xl font-black">4.9</p>
            ...
            <div className="w-28 h-28 sm:w-32 sm:h-32 bg-white/20 rounded-full backdrop-blur-md flex flex-col items-center justify-center border border-white/30 text-center shadow-inner hidden sm:flex">
              <p className="text-2xl sm:text-3xl font-black">~8m</p>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 pt-16">
        <div className="bg-white rounded-3xl p-6 sm:p-10 border border-gray-100 shadow-sm">
          <div className="text-center max-w-xl mx-auto space-y-2">
            ...
            <h2 className="text-2xl sm:text-3xl font-extrabold text-[#14213D]">How Diblo Works</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-4 gap-6 pt-10">
            {[
              ...
              <div key={idx} className="relative space-y-2 bg-gray-50/70 p-5 rounded-2xl border border-gray-100">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 pt-12">
        <div className="bg-gradient-to-br from-[#14213D] to-[#1E293B] text-white rounded-3xl p-6 sm:p-10 shadow-xl relative overflow-hidden">
          ...
          <div className="absolute top-0 right-0 w-96 h-96 bg-[#F42F73]/10 rounded-full blur-3xl" />
            ...
            <div className="space-y-4">
              ...
              <div className="pt-2 grid grid-cols-2 gap-3 text-xs font-semibold">
                <div className="flex items-center gap-2 bg-white/5 p-3 rounded-xl border border-white/10">
                  <FileCheck className="w-4 h-4 text-[#F42F73]" />
                ...
                {MOCK_ASSISTANTS.slice(0, 3).map((asst) => (
                  <div key={asst.id} className="bg-white/10 backdrop-blur-md p-3.5 rounded-2xl border border-white/10 flex items-center justify-between gap-3">
                    <div className="flex items-center gap-3">
                      <img src={asst.photo} alt={asst.name} className="w-11 h-11 rounded-full object-cover border border-white/20" />
                      <div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 pt-16">
        <div className="text-center max-w-xl mx-auto space-y-2 mb-8">
          ...
          <h2 className="text-2xl sm:text-3xl font-extrabold text-[#14213D]">Loved by Mumbai Families</h2>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {[
            ...
            <div key={idx} className="bg-white rounded-3xl p-6 border border-gray-100 shadow-sm space-y-3 flex flex-col justify-between">
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 pt-16">
        <div className="text-center space-y-2 mb-8">
          ...
          <h2 className="text-2xl sm:text-3xl font-extrabold text-[#14213D]">Frequently Asked Questions</h2>
        </div>
            ...
            return (
              ...
              >
                <button
                  ...
                  className="w-full text-left p-4 sm:p-5 flex items-center justify-between gap-4 font-bold text-sm text-[#14213D]"
                >
                  <span>{faq.q}</span>
                  <span className={`text-xl font-mono text-[#F42F73] transition-transform ${isOpen ? 'rotate-45' : ''}`}>
                    +
                  </span>
                </button>
                {isOpen && (
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 pt-16">
        <div className="bg-[#FFF0F5] border border-[#F42F73]/20 rounded-3xl p-6 sm:p-8 flex flex-col sm:flex-row items-center justify-between gap-6">
          <div className="space-y-1 text-center sm:text-left">
            <h3 className="text-lg font-bold text-[#14213D]">Need customized assistance or long-term companion booking?</h3>
            <p className="text-xs text-gray-600">Our dedicated Mumbai operations team is available 24x7 to assist you.</p>
          </div>
          <div className="flex flex-wrap items-center gap-3">
            <a
              href="tel:8291919829"
              className="px-5 py-2.5 rounded-xl bg-[#14213D] hover:bg-[#1E293B] text-white font-bold text-xs flex items-center gap-2 transition-all"
            >
            ...
            <a
              ...
              className="px-5 py-2.5 rounded-xl bg-white hover:bg-gray-100 text-[#14213D] border border-gray-200 font-bold text-xs flex items-center gap-2 transition-all"
            >
      ...
      {/* Footer */}
      <footer className="max-w-7xl mx-auto px-4 sm:px-6 pt-16 mt-8 border-t border-gray-200">
        <div className="grid grid-cols-1 sm:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs text-gray-600 font-medium">
              <li>
                <button onClick={() => onOpenLegal('SAFETY')} className="hover:text-[#F42F73] transition-colors">
                  Safety & Verification Policy
                </button>
              </li>
              <li>
                <button onClick={() => onOpenLegal('TERMS')} className="hover:text-[#F42F73] transition-colors">
                  Terms & Conditions
                </button>
              </li>
              <li>
                <button onClick={() => onOpenLegal('PRIVACY')} className="hover:text-[#F42F73] transition-colors">
                  Privacy Policy
                </button>
              </li>
              <li>
                <button onClick={() => onOpenLegal('CANCELLATION')} className="hover:text-[#F42F73] transition-colors">
                  Cancellation & Refund Policy
                </button>
              </li>
              <li>
                <button onClick={() => onOpenLegal('CODE_OF_CONDUCT')} className="hover:text-[#F42F73] transition-colors">
          ...
          <div>
            ...
            <div className="space-y-2 text-xs text-gray-600">
              ...
              <div className="text-[11px] text-gray-400">Headquarters: Bandra Kurla Complex (One BKC), Mumbai - 400051</div>
            </div>
          </div>
        </div>

        <div className="py-6 border-t border-gray-100 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-gray-400">
