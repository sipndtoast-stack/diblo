...
export const CustomerProfile: React.FC = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 space-y-6 pb-24 md:pb-12 text-[#14213D]">
      ...
      <div className="bg-white rounded-3xl p-6 border border-gray-100 shadow-sm flex flex-col sm:flex-row items-center gap-6">
        <img
          src={
          ...
          alt="Avatar"
          className="w-20 h-20 rounded-full object-cover border-4 border-[#FFF0F5] shadow-md"
        />
        <div className="flex-1 text-center sm:text-left space-y-1">
          <div className="flex flex-col sm:flex-row sm:items-center gap-2">
            <h2 className="text-xl font-black text-[#14213D]">{customerProfile?.name || 'Aarav Mehta'}</h2>
            <span className="inline-flex items-center gap-1 bg-emerald-100 text-emerald-800 text-[10px] font-bold px-2 py-0.5 rounded-full mx-auto sm:mx-0">
        ...
        <div className="bg-[#FFF0F5] p-4 rounded-2xl border border-[#F42F73]/20 text-center shrink-0">
          <div className="text-[10px] font-bold text-gray-500 uppercase tracking-wider">Diblo Cash</div>
          <div className="text-xl font-black text-[#F42F73]">₹350.00</div>
          <div className="text-[10px] text-[#14213D] font-medium">Auto-applies at checkout</div>
        </div>
      </div>

      {/* Refer & Earn Banner */}
      <div className="bg-gradient-to-r from-[#14213D] to-[#1E293B] text-white rounded-3xl p-6 flex flex-col sm:flex-row items-center justify-between gap-4">
        <div className="space-y-1 text-center sm:text-left">
          <div className="flex items-center gap-1.5 text-[#F42F73] text-xs font-extrabold uppercase">
            <Gift className="w-4 h-4" />
            <span>Refer Friends & Family in Mumbai</span>
          </div>
          <h3 className="text-lg font-bold">Earn ₹100 Diblo Cash for every verified referral</h3>
        ...
        <div className="flex items-center gap-2 bg-white/10 p-2 rounded-2xl border border-white/20">
          <span className="font-mono font-bold text-xs px-2 text-white">DIBLO-AARAV100</span>
          <button
            onClick={handleCopyReferral}
            className="px-3 py-1.5 rounded-xl bg-[#F42F73] hover:bg-[#D81B60] text-white text-xs font-bold transition-all"
          >
          ...
          <div className="bg-gray-50 p-4 rounded-2xl border border-gray-200 space-y-3">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="px-4 py-2 bg-[#F42F73] text-white text-xs font-bold rounded-xl"
              >
                Save Address
              </button>
              <button
          ...
          {customerProfile?.savedAddresses.map((addr) => (
            ...
            >
              <div className="flex items-start gap-3">
                <MapPin className="w-4 h-4 text-[#F42F73] mt-0.5" />
                <div>
      ...
      <div className="bg-white rounded-3xl p-6 border border-gray-100 shadow-sm space-y-3">
        <div className="flex items-center gap-2">
          <Heart className="w-4 h-4 text-[#F42F73]" />
