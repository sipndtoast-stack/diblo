  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 space-y-6 pb-24 md:pb-12 text-[#14213D]">
      <div>
        ...
        <h1 className="text-2xl font-black mt-1">Diblo Support & Assistance</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <a
          href="tel:8291919829"
          className="bg-white p-5 rounded-3xl border border-gray-100 shadow-sm hover:border-[#F42F73] transition-all flex flex-col items-center text-center space-y-2 group"
        >
        ...
        <div className="bg-white p-5 rounded-3xl border border-gray-100 shadow-sm flex flex-col items-center text-center space-y-2">
      ...
      <div className="bg-white rounded-3xl p-6 sm:p-8 border border-gray-100 shadow-sm space-y-4">
        ...
        <form onSubmit={handleSubmitTicket} className="space-y-4">
          ...
          <button
            ...
            className="px-6 py-3 rounded-2xl bg-[#F42F73] hover:bg-[#D81B60] text-white text-xs font-bold shadow-md shadow-[#F42F73]/20 flex items-center gap-2 transition-all"
          >
