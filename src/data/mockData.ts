...
export const MOCK_BOOKINGS: Booking[] = [
  ...
  {
    id: 'bk-105',
    bookingNumber: 'DBL-2026-8650',
    customerId: 'cust-1',
    customerName: 'Aarav Mehta',
    customerPhone: '9820123456',
    serviceId: 'personal-errand-assistance',
    serviceName: 'Personal Errand Assistance',
    serviceIcon: 'Clock',
    location: {
      address: 'B-702, Sea Green Apartments, Carter Road, Bandra West',
      area: 'Bandra West',
    ...
    taxAmount: 15,
    totalAmount: 313,
    instructions: 'Collect tailored suits from Raymond Bandra and pick up courier packet.',
    genderPreference: 'ANY',
    status: 'COMPLETED',
    assistantId: 'asst-1',
    assistantName: 'Rajesh Sharma',
    ...
    completedAt: '2026-09-15T13:00:00Z'
  },
  {
    id: 'bk-106',
    bookingNumber: 'DBL-2026-8510',
    customerId: 'cust-1',
    customerName: 'Aarav Mehta',
    customerPhone: '9820123456',
    serviceId: 'senior-citizen-assistance',
    ...
    taxAmount: 22,
    totalAmount: 469,
    instructions: 'Evening promenade walk accompaniment and medicine box sorting.',
    genderPreference: 'ANY',
    status: 'COMPLETED',
    assistantId: 'asst-1',
    assistantName: 'Rajesh Sharma',
    ...
    completedAt: '2026-08-22T20:00:00Z'
  },
  {
    id: 'bk-107',
    bookingNumber: 'DBL-2026-8480',
    customerId: 'cust-1',
    customerName: 'Aarav Mehta',
    customerPhone: '9820123456',
    serviceId: 'hospital-visit-assistance',
    ...
    serviceIcon: 'Stethoscope',
    location: {
      address: 'Hinduja Hospital, Mahim West',
      area: 'Mahim',
      lat: 19.0330,
      lng: 72.8400
    },
    ...
    taxAmount: 22,
    totalAmount: 469,
    instructions: 'Father routine blood work and nephrology consultation queue escort.',
    genderPreference: 'ANY',
    status: 'COMPLETED',
    assistantId: 'asst-2',
    assistantName: 'Priya Shinde',
  ...
  },
  {
    ...
    taxAmount: 20,
    totalAmount: 417,
    instructions: 'Dry fruits and spice sourcing at Crawford market bazaar.',
    genderPreference: 'ANY',
    status: 'COMPLETED',
    assistantId: 'asst-5',
    assistantName: 'Anjali Nair',
    assistantPhone: '9833990011',
    assistantRating: 4.97,
    startOtp: '7192',
    paymentStatus: 'PAID',
    paymentMethod: 'UPI',
  ...
  },
  {
    ...
    taxAmount: 15,
    totalAmount: 313,
    instructions: 'Companion for father morning clinic appointment and chemist purchase.',
    genderPreference: 'ANY',
    status: 'COMPLETED',
    assistantId: 'asst-1',
    assistantName: 'Rajesh Sharma',
  ...
  },
  {
    ...
    taxAmount: 30,
    totalAmount: 626,
    instructions: 'Comprehensive cardiac executive checkup escort and report coordination.',
    genderPreference: 'ANY',
    status: 'COMPLETED',
    assistantId: 'asst-1',
    assistantName: 'Rajesh Sharma',
    ...
    startedAt: '2026-06-20T08:30:00Z',
    completedAt: '2026-06-20T12:30:00Z'
  },
  {
    id: 'bk-111',
    bookingNumber: 'DBL-2026-8110',
    customerId: 'cust-1',
    customerName: 'Aarav Mehta',
    customerPhone: '9820123456',
    serviceId: 'personal-errand-assistance',
    ...
    taxAmount: 15,
    totalAmount: 313,
    instructions: 'Collect repaired laptop from Bandra IT center and submit paperwork.',
    genderPreference: 'ANY',
    status: 'COMPLETED',
    assistantId: 'asst-4',
    assistantName: 'Suresh Patil',
    ...
    completedAt: '2026-06-08T17:00:00Z'
  },
  {
    id: 'bk-112',
    bookingNumber: 'DBL-2026-7990',
    customerId: 'cust-1',
    customerName: 'Aarav Mehta',
    customerPhone: '9820123456',
    serviceId: 'senior-citizen-assistance',
    ...
    taxAmount: 22,
    totalAmount: 469,
    instructions: 'Sunset walk at Joggers Park Bandra followed by reading session.',
    genderPreference: 'ANY',
    status: 'COMPLETED',
    assistantId: 'asst-1',
    assistantName: 'Rajesh Sharma',
    ...
    startedAt: '2026-05-27T16:30:00Z',
    completedAt: '2026-05-27T19:30:00Z'
  },
  {
    id: 'bk-113',
    bookingNumber: 'DBL-2026-7910',
    customerId: 'cust-1',
    customerName: 'Aarav Mehta',
    customerPhone: '9820123456',
    serviceId: 'shopping-assistance',
    ...
    taxAmount: 20,
    totalAmount: 417,
    instructions: 'Luggage handling and boutique assistance during family wardrobe shopping.',
    genderPreference: 'ANY',
    status: 'COMPLETED',
    assistantId: 'asst-2',
    assistantName: 'Priya Shinde',
  ...
  },
  {
    ...
    taxAmount: 15,
    totalAmount: 313,
    instructions: 'Morning walk and assistance with digital banking setup for father.',
    genderPreference: 'ANY',
    status: 'COMPLETED',
    assistantId: 'asst-1',
    assistantName: 'Rajesh Sharma',
  ...
  },
  {
    ...
    taxAmount: 17,
    totalAmount: 364,
    instructions: 'Routine ophthalmology appointment and spectacles pickup assistance.',
    genderPreference: 'ANY',
    status: 'COMPLETED',
    assistantId: 'asst-1',
    assistantName: 'Rajesh Sharma',
...
export const MOCK_COUPONS: Coupon[] = [
  ...
  },
  {
    ...
    usedCount: 0,
    isActive: true,
    description: 'Referral Reward: ₹100 OFF on your next booking from inviting Vikram Malhotra'
  },
  {
    id: 'cp-ref-2',
    code: 'REF-SNEHA100',
    ...
    usedCount: 0,
    isActive: true,
    description: 'Referral Reward: ₹100 OFF on your next booking from inviting Sneha Deshmukh'
  }
];
...
export const MOCK_REFERRALS: Referral[] = [
  {
    ...
    friendPhone: '9820554433',
    status: 'COMPLETED',
    serviceBooked: 'Hospital Visit OPD Queue Assistance',
    rewardCouponCode: 'REF-VIKRAM100',
    rewardAmount: 100,
    isClaimed: false,
    createdAt: '2026-09-02T10:15:00Z',
    completedAt: '2026-09-08T15:40:00Z'
  },
  {
    id: 'ref-2',
    referrerCustomerId: 'cust-1',
    referrerName: 'Aarav Mehta',
    friendName: 'Sneha Deshmukh',
    friendPhone: '9819887766',
    status: 'COMPLETED',
    serviceBooked: 'Senior Citizen Morning Walk & Doctor Escort',
    rewardCouponCode: 'REF-SNEHA100',
    rewardAmount: 100,
    isClaimed: false,
  ...
  },
  {
    ...
    referrerCustomerId: 'cust-1',
    referrerName: 'Aarav Mehta',
    friendName: 'Rohan Kulkarni',
    friendPhone: '9820112233',
    status: 'REGISTERED',
    rewardAmount: 100,
    isClaimed: false,
